...
# Flag for switching of external input
...
# Dictionary for data to be saved
save_data = {"D":D,
	"spt_e":spt_e,
	"spt_i":spt_i,
	"Pos_e":X_e.tolist(),
...
path = sim_data_base_folder + "spiketime_dataset_instant_diffusion/"  #set path for saving sim.
