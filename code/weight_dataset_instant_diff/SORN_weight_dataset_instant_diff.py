...
def IP():
	...
	rho+=(NOS_Th[:,1]/1000.).sum()*dt_ip/size_T**2 # divide by 1000 to get from production/s -> production/ms
...
save_data = {"D":D,
	"spt_e":spt_e,
	"spt_i":spt_i,
	"W_eTOe":C_eTOe.W.todense().tolist()}

path = sim_data_base_folder + "weights_spiketimes_dataset_instant_diff/"  #set path for saving sim.
