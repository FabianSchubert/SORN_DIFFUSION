...
### Base parameters
run_time = 2500. * second # run time, default 2500. * second
t_switch = 500. * second # time to switch between hom. mechanisms non diff -> diff, default 500 second
t_switch_ext = 800. * second # time to switch on external input, default 800 second
t_syn_plast_off = 2500. * second # optional removal of synaptic plasticity mechanisms
syn_plast_switch = False # activate or deactivate switching

size_T = 1000 # sheet length, microns
width_T = 200 # growth radius, microns
use_topol = True #Use distant-dependent growth probability?
...
### Ext. input
f_ext = 2.5 *hertz # external poisson input rate
N_ext = int(N_e*0.25) # Size of external input group
...
ip_time = 1. * ms # default: 1 ms, fast clock for accurate calculation of intrinsic plasticity
