...
### Base parameters
run_time = 1500. * second # run time, default 2500. * second
...
h = size_T/N_grid
hsqr = h**2
D = 100. # (micrometer^2)/ms, Sweeney 2015 paper had 12.5 times the amount of neurons -> adapt for scale
...
w_rec_time = 1000 * ms # clock for recording of synaptic connectivity
