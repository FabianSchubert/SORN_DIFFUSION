...
# This script plots the sum of outgoing excitatory weights among the excitatory population against their mean firing rate.
...
plot_filename = "sum_out_weights_vs_rate"
...
ax.set_ylabel("Sum of Outg. W. [mV]")
